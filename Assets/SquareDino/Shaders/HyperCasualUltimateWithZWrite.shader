...
Shader "SquareDino/HyperCasualUltimateWithZWrite"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[HideInInspector] _FlashMode ("__flashMode", Float) = 0.0
		[HideInInspector] _FlashPureMode ("__flashPureMode", Float) = 0.0
	...
	SubShader
	{
        ...
        #pragma shader_feature _FLASHMODE
        #pragma shader_feature _FLASHMODEPURECOLOR
        ...
        void surf(Input input, inout SurfaceOutputCustom output)
        {
            ...
            #ifdef _FLASHMODE
            output.Albedo = lerp(output.Albedo, _FlashColor.rgb, _FlashAmount);
            #endif
        }
	...
	Fallback "Diffuse"
	CustomEditor "HyperCasualShaderGUI"
